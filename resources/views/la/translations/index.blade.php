...
@section("contentheader_description", "Translations listing")
@section("section", "Translations")
@section("sub_section", "Listing")
@section("htmlheader_title", "Translations Listing")

@section("headerElems")
@la_access("Translations", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add Translation</button>
@endla_access
@endsection
