...
<div id="page-content" class="profile2">
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/agency_main_pages') }}" data-toggle="tooltip" data-placement="right" title="Back to Agency main pages"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'left_image')
						@la_display($module, 'right_image')
						@la_display($module, 'bottom_image')
