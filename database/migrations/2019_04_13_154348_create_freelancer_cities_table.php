...
class CreateFreelancerCitiesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Freelancer_cities", 'freelancer_cities', 'title_en', 'fa-cube', [
    ...
    {
        if (Schema::hasTable('freelancer_cities')) {
            Schema::drop('freelancer_cities');
        }
    }
}
