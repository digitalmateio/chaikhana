...
class CreateAgencyMainPagesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Agency_main_pages", 'agency_main_pages', 'title_en', 'fa-file-text-o', [
            ...
            ["left_image", "left image", "Image", false, "", 0, 0, false],
            ["right_image", "right image", "Image", false, "", 0, 0, false],
            ["bottom_image", "bottom image", "Image", false, "", 0, 0, false],
            ["position", "position", "Multiselect", false, "", 0, 0, false, ["top","bottom"]],
        ]);
    ...
    {
        if (Schema::hasTable('agency_main_pages')) {
            Schema::drop('agency_main_pages');
        }
    }
}
