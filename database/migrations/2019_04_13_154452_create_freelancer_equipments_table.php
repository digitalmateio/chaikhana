...
class CreateFreelancerEquipmentsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Freelancer_equipments", 'freelancer_equipments', 'title_en', 'fa-sheqel', [
    ...
    {
        if (Schema::hasTable('freelancer_equipments')) {
            Schema::drop('freelancer_equipments');
        }
    }
}
