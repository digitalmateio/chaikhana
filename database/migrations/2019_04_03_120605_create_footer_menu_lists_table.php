...
class CreateFooterMenuListsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Footer_menu_lists", 'footer_menu_lists', 'title_en', 'fa-angellist', [
            ...
            ["link", "url link", "String", false, "", 0, 256, false],
        ]);
    ...
    {
        if (Schema::hasTable('footer_menu_lists')) {
            Schema::drop('footer_menu_lists');
        }
    }
}
