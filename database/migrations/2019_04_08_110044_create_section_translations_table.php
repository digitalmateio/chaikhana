...
class CreateSectionTranslationsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Section_translations", 'section_translations', 'title', 'fa-language', [
            ["section_id", "section_id", "Integer", false, "", 0, 0, false],
            ["locale", "locale", "Integer", false, "", 0, 0, false],
            ["title", "title", "Integer", false, "", 0, 0, false],
            ["story_id", "story_id", "Integer", false, "", 0, 0, false],
            ["asset_id", "asset_id", "Integer", false, "", 0, 0, false],
        ]);
