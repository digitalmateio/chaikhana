...
class CreateShoppingCountriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Module::generate("Shopping_countries", 'shopping_countries', 'title', 'fa-flag', [
    ...
    {
        if (Schema::hasTable('shopping_countries')) {
            Schema::drop('shopping_countries');
        }
    }
}
