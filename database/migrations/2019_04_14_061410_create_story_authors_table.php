...
class CreateStoryAuthorsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Story_authors", 'story_authors', 'story_id', 'fa-user-md', [
            ["story_id", "story", "Dropdown", false, "", 0, 0, false],
            ["author_id", "author", "Dropdown", false, "", 0, 0, false],
        ]);
    ...
    {
        if (Schema::hasTable('story_authors')) {
