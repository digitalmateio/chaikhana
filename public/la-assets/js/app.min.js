    ...
    function getLI(upload) {
        ...
        if($.inArray(upload.extension, ["jpg", "jpeg", "png", "gif", "bmp"]) > -1) {
            ...
            switch (upload.extension) {
                ...
                case "mp3":
                    image = upload.name;
//                    image = '<i class="fa fa-file-audio-o"></i>'+upload.name;
                    break;
                case "wav":
                    image = upload.name;
                    break;
    ...
    fm_dropzone = new Dropzone("#fm_dropzone", {
        maxFilesize: 200,
        acceptedFiles: "image/*,application/pdf,.mp3,.wav,.flac,.wma",
        init: function() {
            this.on("error", function(file) {
                // console.log(file); // mushaobs errori
            });  
...
//                $hinput.next("a").next(".uploaded_file").attr("href", upload.thumbnails[Object.keys(upload.thumbnails)[0]]);
            ...
            var fileImage = "";
            if(upload.extension == "jpg" || upload.extension == "png" || upload.extension == "gif" || upload.extension == "jpeg") {
//                console.log( Object.keys(upload.thumbnails) );
//                alert( Object.keys(upload.thumbnails)[0] );
                fileImage = "<img src='"+upload.thumbnails[ Object.keys(upload.thumbnails)[1] ]+"'>";
            } else {
